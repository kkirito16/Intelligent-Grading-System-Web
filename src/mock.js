const dynamicUser = [
    {
        ...
        routes: [
            ...
            { id: 2, name: "/grading", path: "/grading", component: "Layout", redirect: "/grading/index", hidden: false, children: [
                { name: "/grading/index", path: "/grading/index", meta: { title: "grading" }, component: "grading/index" }
            ]},
            { id: 3, name: "/analysis", path: "/analysis", component: "Layout", redirect: "/analysis/index", hidden: false, children: [
                { name: "/analysis/index", path: "/analysis/index", meta: { title: "analysis" }, component: "analysis/index" }
            ] }
        ]
    }
    // {
